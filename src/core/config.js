...
const SCRIPT_CONFIG = {
    ...
    CHANGELOG: {
        '1.21.11.3': [
            '【修复】AMEQP答题卡取图裁切到题块可视区域，不再发送整张答题卡',
            '【修复】AMEQP填分后同步平台隐藏字段并延迟提交，避免"没给分"误跳下一份',
            '【修复】AMEQP任务标识改用题号，修复绑定试题后仍重复弹出引导界面的问题',
        ],
        '1.21.11.2': [
        ...
        '1.21.9': [
            ...
            '【新平台】新增粤教翔云智慧测评平台适配，支持题组批改模式',
            '【新平台】新增云阅卷(好分数)平台适配，Vue 3 + Element Plus 框架',
            '【新平台】新增光大阅卷 V2 平台适配，支持 IP:端口部署版本',
            '【修复】修复五岳阅卷平台更新后无法获取答题卡图片的问题，改用 DOM 结构匹配替代 URL 模式匹配',
            '【文档】更新文档站，平台数量从 14 个扩展到 19 个',
            '【文档】为 5 个新平台创建独立文档页面',
            '【文档】更新平台对比表、快速导航、SEO meta 信息',
            '【优化】科耘适配器初始化时自动取消"打分键盘"勾选，避免键盘输入被捕获导致误填分数',
            '【优化】科耘适配器采用延迟填分模式，用户确认后才填入分数触发自动提交',
            '【优化】科耘适配器提交前自动勾选"自动提交"，确保填分后平台能正常提交',
        ],
        '1.21.8': [
            '【新平台】新增54学霸阅卷平台适配，支持 Canvas/base64 图片渲染和多小题输入框评分',
            '【新平台】新增九科星阅卷平台适配，支持多小题评分和图片裁剪功能',
            '【新平台】新增慧阅卷平台适配，支持 frame 内部文档访问和评分功能',
            '【新平台】新增乐华阅卷平台适配',
            '【新功能】配置备份与恢复功能，确保更新时配置安全',
            '【新功能】评阅历史面板支持 Markdown 渲染，优化显示效果',
            '【新功能】评分弹窗评语支持滚动显示长评语',
            '【新功能】纠错面板添加 Markdown 编辑器预览功能，支持 AI 润色',
            '【新功能】双评阈值支持设为0，优化仲裁提示词',
            '【优化】AI 评分时自动忽略涂改、划掉的内容，只评判最终保留的答案',
            '【优化】重构 Markdown 渲染器，支持 LaTeX 块级和行内公式',
            '【优化】优化图片获取逻辑，增加有效性验证和超时处理',
            '【优化】改进分数匹配逻辑，优先精确匹配并增加模糊匹配策略',
            '【优化】增强分数解析逻辑，支持负数和超出满分的处理',
            '【优化】优化多个编辑面板的交互体验',
            '【优化】阻止 Enter 键冒泡，避免触发表单提交',
            '【优化】优化各面板 z-index 属性，确保覆盖层优先级正确',
            '【修复】修复五岳阅卷答题卡获取问题和多图片显示问题',
            '【修复】修复光大适配器多个稳定性问题',
            '【修复】修复乐华阅卷等待获取下一份试卷失败的问题',
            '【修复】修复乐华阅卷分数填充逻辑',
            '【修复】修复 OOBE 界面编辑题目后无法显示的问题',
        ],
        '1.21.7': [
        ...
        '1.21.5': [
            ...
            '【新功能】提交对话框新增最小化/恢复功能，最小化后显示分数浮动条，方便核对答题卡',
            '【新功能】提交对话框支持拖动，可自由移动位置查看被遮挡的答题卡',
            '【优化】光大阅卷等待新试卷改用密号变化检测，比得分重置更可靠',
            '【优化】XHR 拦截器添加平台域名守卫，仅在对应平台上执行，避免影响其他平台',
            '【修复】修复光大阅卷脚本无法加载的问题（@match 模式从 *:// 改为显式 https://）',
            '【修复】修复 SPA 导航后 UI 不初始化的问题（init 调用移至 early return 之前）',
            '【修复】修复光大阅卷从第二份试卷开始图片不正确的问题',
        ],
        '1.21.4': [
            '【新平台】新增云阅卷平台适配，支持内网阅卷系统的自动批改',
            '【新平台】新增新教育智能平台适配，支持考试系统和作业系统两种批改模式',
            '【新功能】批改进度面板支持拖动，可自由调整位置并自动保存，避免遮挡网页原有内容',
            '【新功能】新手引导验证密钥时显示加载动画',
            '【新功能】新手引导验证密钥时自动清除之前的错误提示',
            '【优化】API 密钥验证速度优化，使用固定回复减少响应时间',
            '【优化】批改进度面板圆角样式优化',
            '【修复】修复新手引导弹窗可能重复弹出的问题',
            '【修复】修复批阅进度计数不更新的问题',
            '【修复】修复批改进度面板无法拖动的问题',
            '【修复】修复新手引导验证动画在深色按钮上不可见的问题',
        ],
        '1.21.3.0': [
